...
first element is the sum of those numbers, and the 
second element is a concatenated string that EXACTLY follows this example and uses the values that were input into the function:
...
function sum(a, b) { //eslint-disable-line
  ...
  var answer = [ testsum , 'The sum of '+a+ ' and '+b+' is '+testsum+'.'];
...
// return('The sum of '+a+ ' and '+b+' is'+testsum+'.');
...
function multiply(a, b) { //eslint-disable-line
    ...
    // console.log( testMultiply,'The product of '+a+ ' and '+b+' is '+testMultiply+'.' );
...
that takes in three numbers as separate arguments and 
...
IMPORTANT DETAIL: You may not use the arithmetic operators + and * in this function.
 To do addition, use your sum() function, 
